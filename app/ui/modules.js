...
function renderModules(modules) {
    ...
    modules.map((t) => {
        ...
        <table class="table table-dark">
            ...
            <th style="width:100px; display:inline-block; overflow:hidden">Semester</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Subject Name</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Subject Code</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Lecture Hours</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Tutorial Hours</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Lab Hours</th>
            <th style="width:100px; display:inline-block; overflow:hidden">Evaluation Hours</th>
            </tr>
        </thead>
        <tbody>
        <tr>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.offeredYear}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.offeredSem}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.sName}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.sCode}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.lHours}.${t.lMins}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.tHours}.${t.tMins}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.labHours}.${t.labMins}</td>
          <td style="width:100px; display:inline-block; overflow:hidden">${t.eHours}.${t.eMins}</td>
          <td><button class="btn btn-primary btn-sm" onclick="editModule('${t._id}')">
          ✎ Edit
        </button></td>
        <td><button class="btn btn-danger btn-sm" onclick="deleteModule('${t._id}')">
          🗑 Delete
        </button></td>
        </tr>
      </tbody>
